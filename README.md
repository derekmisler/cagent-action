...
1. **Add the action to your workflow**:
   ...
   ```yaml
   - uses: derekmisler/cagent-action@latest
     with:
...
jobs:
  review:
    uses: derekmisler/cagent-action/.github/workflows/review-pr.yml@latest
...
- 🐛 [Report Issues](https://github.com/derekmisler/cagent-action/issues)
- 💬 [Discussions](https://github.com/derekmisler/cagent-action/discussions)
